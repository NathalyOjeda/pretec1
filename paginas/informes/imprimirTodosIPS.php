...
$query = $base_datos->conectar()->prepare("SELECT 
           ...
           di.det_ips_estado
            ...
            WHERE di.det_ips_fe_pg BETWEEN '" . $_GET['desde'] . "' and '" . $_GET['hasta'] . "'");
...
<html lang="es">
    ...
    <body style="margin: 30px auto; 
        ...
        <h2 style="margin-top: 20px;"><center>INFORME DE IPS POR PERIODO</center></h2>
        <hr> 
        <div class="container">
            <div class="row">
                <div class="col-md-12">
