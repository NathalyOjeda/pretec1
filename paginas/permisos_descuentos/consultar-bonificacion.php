...
<h3>Busqueda de Bonificación</h3>
<div class="row">
    <div class="col-md-4">
        <label>Cédula</label>
    ...
    <div class="col-md-3" style="display: none;">
     ...
     <div class="col-md-1">
        <label>.</label>
        <button class="btn btn-primary form-control" onclick="buscarSancion(); return false"><i class="ti ti-search"></i></button>
    </div>
</div>
