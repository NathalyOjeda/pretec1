...
<div class="row">
    ...
    <div class="col-md-3" style="display: none;">
     ...
     <div class="col-md-1">
        <label>.</label>
        <button class="btn btn-primary form-control" onclick="buscarPermiso(); return false"><i class="ti ti-search"></i></button>
    </div>
</div>
