...
function guardar($lista) {
    ...
    $base_datos = new DB();
    $query = $base_datos->conectar()->prepare("INSERT INTO `curriculum_exp_laboral`( 
    `cur_id`, `empresa`, `telefono`, `descripcion`) 
    VALUES (:cur_id, :empresa, :telefono,  :descripcion)");

    $query->execute([
        'cur_id' => $json_datos['cur_id'],
        'empresa' => $json_datos['empresa'],
...
function eliminar($id) {
    ...
    $query = $base_datos->conectar()->prepare(""
            . " DELETE FROM curriculum_exp_laboral "
            . " WHERE cur_id = $id");
