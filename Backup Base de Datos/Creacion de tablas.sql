...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2021 a las 20:07:23
...
INSERT INTO `det_salario` (`det_salario_id`, `con_id`, `bon_flia`, `sal_id`, `sal_mes`, `total_extra`, `total_descuento`, `sal_fec_emis`, `det_ips_id`, `estado`) VALUES
...
(1, 'OJEDA', 'LUCERO', 4444, '2021-09-07', 'CAPIATA EN ALGUN LUGAR', 'FEMENINO', 'CAPIATA', 'PARAGUAYA', 'CASADO', 'LUCERO@GMAIL.COM', '09128312'),
(2, 'GOMEZ', 'LUCAS', 33112, '2021-09-07', 'CAPIATA EN ALGUN LUGAR', 'MASCULINO', 'CAPIATA', 'PARAGUAYA', 'SOLTERO', 'LUCAS@GMAIL.COM', '09128312'),
(3, 'GUZMAN', 'LUIS', 331121, '1994-01-07', 'ITAUGUA', 'MASCULINO', 'CAPIATA', 'PARAGUAYA', 'SOLTERO', 'LUCAS@GMAIL.COM', '09128312'),
(5, 'GOMEZ', 'LUIS', 5431318, '2021-10-05', 'Itaugua', 'MASCULINO', 'Itaugua Guazu', 'ASDAAA', 'SOLTERO', 'ASDAAA', '0971120612'),
(6, 'MEZAA', 'JORGE', 234234, '2021-10-05', 'Itaugua', 'MASCULINO', 'Itaugua Guazu', 'ASDAAA', 'SOLTERO', 'ASDAAA', '0971120612'),
(7, 'MEZAA', 'RONALDO', 12312312, '2021-10-12', 'Itaugua', 'MASCULINO', 'Itaugua Guazu', 'ASDAAA', 'CASADO', 'ASDAAA', '0971120612'),
(8, 'MEZAA', 'MENGANO', 12312312, '2021-10-12', 'Itaugua', 'MASCULINO', 'Itaugua Guazu', 'ASDAAA', 'CASADO', 'ASDAAA', '0971120612');
...
(2, 'lucas', '202cb962ac59075b964b07152d234b70', 'RECURSOS HUMANOS', 'ACTIVO', 2, 0, 3),
(3, 'luis', '202cb962ac59075b964b07152d234b70', 'INFORMES', 'ACTIVO', 3, 0, 3);
...
ALTER TABLE `det_salario`
  ...
  ADD KEY `det_ips_det_salario_fk` (`det_ips_id`),
  ADD KEY `con_id` (`con_id`);
...
ALTER TABLE `permiso`
  ...
  ADD KEY `justificacion_permiso_fk` (`jus_per_id`);
...
--
ALTER TABLE `aguinaldo`
  MODIFY `agui_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `asistencia`
--
ALTER TABLE `asistencia`
  MODIFY `asi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `det_salario`
  MODIFY `det_salario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sancion`
  MODIFY `san_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `curriculum`
  ADD CONSTRAINT `personal_curriculum_fk` FOREIGN KEY (`per_id`) REFERENCES `personal` (`per_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `det_salario`
  ADD CONSTRAINT `det_ips_det_salario_fk` FOREIGN KEY (`det_ips_id`) REFERENCES `det_ips` (`det_ips_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `permiso`
  ...
  ADD CONSTRAINT `justificacion_permiso_fk` FOREIGN KEY (`jus_per_id`) REFERENCES `justi_perm` (`jus_per_id`);
